...
with col1:
    st.markdown("### Digit 1")
    canvas1 = st_canvas(fill_color="black", stroke_width=20, stroke_color="black", background_color="white", height=280, width=280, drawing_mode="freedraw", key="canvas1")
with col2:
    st.markdown("### Digit 2")
    canvas2 = st_canvas(fill_color="black", stroke_width=20, stroke_color="black", background_color="white", height=280, width=280, drawing_mode="freedraw", key="canvas2")
with col3:
    st.markdown("### Digit 3")
    canvas3 = st_canvas(fill_color="black", stroke_width=20, stroke_color="black", background_color="white", height=280, width=280, drawing_mode="freedraw", key="canvas3")
